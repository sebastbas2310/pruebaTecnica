...
const initialUsers = [
  { id: 1, nombre: "Juan Perez", correo: "juan@example.com", telefono: "3001234567", rol: "ADMIN" },
  { id: 2, nombre: "Ana Gomez", correo: "ana@example.com", telefono: "3007654321", rol: "USER" },
];
        ...
        {deleteUser && (
          <div className="absolute inset-0 bg-black bg-opacity-40 flex justify-center items-center">
            <div className="bg-white p-6 rounded shadow-md w-72 text-center space-y-4">
              ...
              <p>¿Estás seguro de que deseas eliminar a <strong>{deleteUser.nombre}</strong>?</p>
